...
global.rasa_endpoint =
  process.env.rasa_endpoint || process.env.npm_package_config_rasa_endpoint;
global.jwtsecret =
...
global.admin_username =
  process.env.admin_username || process.env.npm_package_config_admin_username;
global.admin_password =
  process.env.admin_password || process.env.npm_package_config_admin_password;
global.db_schema =
  process.env.db_schema || process.env.npm_package_config_db_schema;
global.db_autoupdate =
  process.env.db_autoupdate || process.env.npm_package_config_db_autoupdate;
      ...
      try {
        ...
        if (error !== null) {
          logger.winston.error(
            "--> Unable to connect to Rasa Server: " + error
          );
        }
      } catch (err) {
